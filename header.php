...
<head>
  ...
  if (!empty($site_title)) {
    // If the site title is set, add it to the title
    echo ucwords($site_title) . (is_front_page() ? '' : ' | ') . ucwords($page_title);
  } else {
    // If the site title is not set, only use the page title
